// github.com/andy489
/*
     Да се напише shell скрипт, който приема точно три аргумента - име на директория, старо файлове разширение и ново файлово
    разширение. Във всички директории с подаденото име, скрипта да поставя на всички файлове с подаденото старо разширение - новото
    разширение.
